				 ...
				 <div class="col-lg-1">
				  ...
				  <div class="col-lg-3">
					<div class="form-group">
					  <input type="text" class="form-control" id="title" name="title" placeholder="Enter a title" required autocomplete="off">
					</div>
				  </div>
				  <div class="col-lg-3">
				    <div class="form-group">
						<select class="form-control" id="type" name="type" placeholder="type" required autocomplete="off">
				  ...
				  <div class="col-lg-3">
					<div class="form-group">
					  <input type="number" class="form-control" id="year" name="year" placeholder="Enter the year" required autocomplete="off">
					</div>
				  </div>
				  <div class="col-lg-1">
					<div class="form-group">
					  <input type="submit" class="btn btn-primary" id="searchmovie" name="searchmovie" value="SEARCH" style="background-color: #FF8D1B; border: 1px solid #FF8D1B;">
					</div>
				  </div>
				 <div class="col-lg-1">
				 </div>
...
$type = $_POST["type"];
$year = $_POST["year"];
$url = file_get_contents("http://www.omdbapi.com/?t=$title&type=$type&y=$year&plot=short&tomatoes=true&r=json&apikey=130569d0");
$json = json_decode($url, true); //This will convert it to an array
$response = $json['Response'];
if($response == 'True'){
$movie_title = $json['Title'];
$movie_type = $json['Type'];
					...
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
						<div class="w3_agile_featured_movies">
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="#" class="hvr-shutter-out-horizontal"><img src="<?php echo $movie_poster; ?>" title="<?php echo $movie_title; ?>" class="img-responsive" alt="<?php echo $movie_title; ?>" />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="#"><?php echo $movie_title; ?></a></h6>							
									</div>
...
if($response == 'False'){
?>
<h4 class="text-center" style="font-size: 70px; margin-top: 100px; margin-bottom: 100px;">Ooops, Movie Not Found ...</h4>
<?php
}
} else {
?>
				...
				<div id="owl-demo" class="owl-carousel owl-theme">
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							<a href="#" class="hvr-shutter-out-horizontal"><img src="images/m13.jpg" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							<a href="#" class="hvr-shutter-out-horizontal"><img src="images/m11.jpg" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="#">X-Men</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							<a href="#" class="hvr-shutter-out-horizontal"><img src="images/m12.jpg" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="#">Greater</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							<a href="#" class="hvr-shutter-out-horizontal"><img src="images/m7.jpg" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="#">Don't Think Twice</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">
	...
	<div class="footer">
		<div class="container">
			<div class="w3ls_footer_grid">
				<center>
				<div class="col-md-12 w3ls_footer_grid_left">
			...
			<div class="col-md-5 w3ls_footer_grid1_left">
				<p>&copy; 2019. All rights reserved</a></p>
			</div>
